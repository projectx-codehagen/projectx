...
import { ArrowDownIcon, ArrowRightIcon, ArrowUpIcon, CalendarIcon, MoreHorizontal } from 'lucide-react'
    ...
    <div className="w-full max-w-6xl mx-auto space-y-8">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-2xl font-bold">Account Transactions</CardTitle>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>You've made {transactions.length} transactions this period.</CardDescription>
        </CardHeader>
        <CardContent>
